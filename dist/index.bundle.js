...
/* harmony export */   "clearCatDom": () => (/* binding */ clearCatDom),
/* harmony export */   "clearProjectDom": () => (/* binding */ clearProjectDom),
/* harmony export */   "deleteProjectDom": () => (/* binding */ deleteProjectDom),
...
/* harmony import */ var _editanddeleteDOM__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./editanddeleteDOM */ "./src/editanddeleteDOM.js");
...
function getProjects() {
    ...
    _icons__WEBPACK_IMPORTED_MODULE_1__.iconClass.push(
...
function addProjectToStorage() {
    ...
    localStorage.setItem('categories', JSON.stringify(_icons__WEBPACK_IMPORTED_MODULE_1__.iconClass));
}
...
function deleteProjectDom(index, id) {
    const taskDomUpdate = (0,_editanddeleteDOM__WEBPACK_IMPORTED_MODULE_3__.taskIconFunctions)();
    ...
    for (let i = 0; i < _icons__WEBPACK_IMPORTED_MODULE_1__.iconClass.length; i++) {
        if (_icons__WEBPACK_IMPORTED_MODULE_1__.iconClass[i].id === parentid) {
            _icons__WEBPACK_IMPORTED_MODULE_1__.iconClass.splice(i, 1);
            break;
        }
    }
    ...
    for (let i = 0; i < _addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__.arr.length; i++) {
        console.log(_addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__.arr.length)
        if (_addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__.arr[i].project === name) {
            taskDomUpdate.trash(i);
        }
    }

    for (let i = 0; i < _addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__.arr.length; i++) {
        (0,_taskobjectfunctions__WEBPACK_IMPORTED_MODULE_2__.deleteObject)(i);
    }
    ...
    addProjectToStorage();
    projectDom();
    (0,_icons__WEBPACK_IMPORTED_MODULE_1__.focusOnStart)();
}
...
function projectDom() {
    ...
    projects.forEach((item, index) => {
        ...
        container.appendChild((0,_addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__.elementFactory)('div', {class: 'new-project', id: `project-${projects[index]}`, data: 'organize', index: `${index}`, type: 'project', name: `${projects[index]}`}));
        document.querySelector(`#project-${projects[index]}`).appendChild((0,_addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__.elementFactory)('div', {id: `name-${index}`, class: 'name'}));
        document.querySelector(`#name-${index}`).appendChild((0,_addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__.elementFactory)('div', {id: `grid-${index}`, index: `${index}`, class: 'grid'}));
        document.querySelector(`#grid-${index}`).appendChild((0,_addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__.elementFactory)('img', {class: 'white-png', src: '../src/grid-white.png', index: `${index}`}));
        document.querySelector(`#name-${index}`).appendChild((0,_addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__.elementFactory)('p', 'none', `${text}`));
        document.querySelector(`#project-${projects[index]}`).appendChild((0,_addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__.elementFactory)('div', {id: `project-trash-${index}`, class: 'project-trash', data: 'project-trash', index: `${index}`}));
        document.querySelector(`#project-trash-${index}`).appendChild((0,_addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__.elementFactory)('img', {id: `project-trash-${index}`, class: 'white-png', src: '../src/trash-white.png', index: `${index}`, data: 'project-trash'}));

        // make a new category title

        newCatContainer.appendChild((0,_addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__.elementFactory)('h2', {id: `cat-project-${projects[index]}`, input: 'dynamic-project', index: `${index}`}, `${text}`));
...
/* harmony import */ var _addingProjectDOM__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./addingProjectDOM */ "./src/addingProjectDOM.js");
...
function completed() {
    ...
    const completedArray = (index) => {
        doneTask.push(_addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__.arr[index]);
        _addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__.arr.splice(index, 1);
        localStorage.clear();
        (0,_taskobjectfunctions__WEBPACK_IMPORTED_MODULE_1__.addToStorage)();
        (0,_addingProjectDOM__WEBPACK_IMPORTED_MODULE_2__.addProjectToStorage)();
    }

    const uncompletedArray = (index) => {
        _addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__.arr.push(doneTask[index]);
...
/* harmony import */ var _taskobjectfunctions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./taskobjectfunctions */ "./src/taskobjectfunctions.js");
/* harmony import */ var _addingtaskDOM__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./addingtaskDOM */ "./src/addingtaskDOM.js");
...
function taskIconFunctions() {
    ...
    const edit = (index) => {
        ...
        title.value = `${_addingtaskDOM__WEBPACK_IMPORTED_MODULE_2__.arr[index].title}`
        description.value = `${_addingtaskDOM__WEBPACK_IMPORTED_MODULE_2__.arr[index].description}`
        date.value = `${_addingtaskDOM__WEBPACK_IMPORTED_MODULE_2__.arr[index].date}`
        taskPop.task();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "catagories": () => (/* binding */ catagories),
/* harmony export */   "focusEffects": () => (/* binding */ focusEffects),
/* harmony export */   "focusOnStart": () => (/* binding */ focusOnStart),
...
/* harmony import */ var _addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./addingtaskDOM */ "./src/addingtaskDOM.js");
/* harmony import */ var _addingProjectDOM__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./addingProjectDOM */ "./src/addingProjectDOM.js");
...
let iconClass = JSON.parse(localStorage.getItem('categories')) || [{
    id: 'project-all',
    class: 'icons'
}, {
...
function catagories() {
    ...
    const currentDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(), 'yyyy-MM-dd');
    const tomorrow = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])((new Date()), {
        days: 1
    })

    const weekLater = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])((new Date()), {
        weeks: 1
    })
    ...
    const stared = () => {
        for (let i = 0; i < _addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__.arr.length; i++) {
            if (_addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__.arr[i].importance === false) {
                document.getElementById(`task-${i}`).style.display = 'none';
            } else if (_addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__.arr[i].importance === true) {
                document.getElementById(`task-${i}`).style.display = 'flex';
            }
        }
    }
    ...
    const today = () => {
        for (let i = 0; i < _addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__.arr.length; i++) {
            if (_addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__.arr[i].date !== currentDate) {
                document.getElementById(`task-${i}`).style.display = 'none';
            } else if (_addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__.arr[i].date === currentDate) {
                document.getElementById(`task-${i}`).style.display = 'flex';
            }
        }
    }
    ...
    const upcoming = () => {
        for (let i = 0; i < _addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__.arr.length; i++) {
            let year = parseInt(_addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__.arr[i].date);
            let month = parseInt(_addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__.arr[i].date[5] + _addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__.arr[i].date[6]) - 1;
            let day = parseInt(_addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__.arr[i].date[8] + _addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__.arr[i].date[9]);
            
            if ((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(year, month, day), {
                start: tomorrow,
                end: weekLater
            }) === true) {
                document.getElementById(`task-${i}`).style.display = 'flex';
    ...
    const dynamicProjects = (project) => {
        for (let i = 0; i < _addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__.arr.length; i++) {
            if (_addingtaskDOM__WEBPACK_IMPORTED_MODULE_0__.arr[i].project === project) {
                document.getElementById(`task-${i}`).style.display = 'flex';
            } else {
                document.getElementById(`task-${i}`).style.display = 'none';
            }
...
function focusEffects(click, index) {
    ...
    const highlight = document.getElementById(`${active.id}`);
        ...
        if (nowActive.id === 'project-important') {
            ...
            cat.upcoming();
        } else if (nowActive.id === `project-${_addingProjectDOM__WEBPACK_IMPORTED_MODULE_1__.projects[index]}`) {
            cat.dynamicProjects(_addingProjectDOM__WEBPACK_IMPORTED_MODULE_1__.projects[index]);
        } 
}
...
/* harmony import */ var _addingtaskDOM__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./addingtaskDOM */ "./src/addingtaskDOM.js");
...
function important() {
    const changePrio = (index, data) => {
        if (data === 'not-important') {
            localStorage.clear();
            _addingtaskDOM__WEBPACK_IMPORTED_MODULE_1__.arr[index].importance = true;
            (0,_taskobjectfunctions__WEBPACK_IMPORTED_MODULE_0__.addToStorage)();
        } else if (data === 'important') {
            localStorage.clear();
            _addingtaskDOM__WEBPACK_IMPORTED_MODULE_1__.arr[index].importance = false;
            (0,_taskobjectfunctions__WEBPACK_IMPORTED_MODULE_0__.addToStorage)();
        }
        checkPrio();
    }
    ...
    const checkPrio = () => {
        for (let i = 0; i < _addingtaskDOM__WEBPACK_IMPORTED_MODULE_1__.arr.length; i++) {
            const notImportant = document.getElementById(`star-${i}`);
            const isImportant = document.getElementById(`important-${i}`);
            if (_addingtaskDOM__WEBPACK_IMPORTED_MODULE_1__.arr[i].importance === true) {
                notImportant.style.display = 'none';
                isImportant.style.display = 'block';
            } else if (_addingtaskDOM__WEBPACK_IMPORTED_MODULE_1__.arr[i].importance === false) {
...
/* harmony export */ });
/* harmony import */ var _addingProjectDOM__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./addingProjectDOM */ "./src/addingProjectDOM.js");
/* harmony import */ var _addingtaskDOM__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./addingtaskDOM */ "./src/addingtaskDOM.js");
...
function getData() {
    ...
    if (num > 0) {
        for (let i = 0; i < _addingProjectDOM__WEBPACK_IMPORTED_MODULE_0__.projects.length; i++) {
            const projectCheck = document.getElementById(`cat-project-${_addingProjectDOM__WEBPACK_IMPORTED_MODULE_0__.projects[i]}`);
            console.log(projectCheck);
            if (projectCheck.style.display === 'block') {
                _addingtaskDOM__WEBPACK_IMPORTED_MODULE_1__.arr.push(taskCreator(title, description, date, _addingProjectDOM__WEBPACK_IMPORTED_MODULE_0__.projects[i]));
                console.log('test');
                break;
            } else {
                continue;
        ...
        _addingtaskDOM__WEBPACK_IMPORTED_MODULE_1__.arr.push(taskCreator(title, description, date));
    }
}

function addToStorage() {
    localStorage.setItem('tasks', JSON.stringify(_addingtaskDOM__WEBPACK_IMPORTED_MODULE_1__.arr));
}

function deleteObject(index) {
    _addingtaskDOM__WEBPACK_IMPORTED_MODULE_1__.arr.splice(index, 1);
    localStorage.clear();
    addToStorage();
    (0,_addingProjectDOM__WEBPACK_IMPORTED_MODULE_0__.addProjectToStorage)();
}
...
const cat = (0,_icons__WEBPACK_IMPORTED_MODULE_1__.catagories)();
...
function printArray() {
    console.log(_addingtaskDOM__WEBPACK_IMPORTED_MODULE_3__.arr);
}
...
function printProject() {
    console.log(_addingProjectDOM__WEBPACK_IMPORTED_MODULE_7__.projects);
    console.log(_icons__WEBPACK_IMPORTED_MODULE_1__.iconClass);
}
...
document.querySelector('body').addEventListener('click', function(e) {
    ...
    switch (id) {
        ...
        case 'add-project':
            ...
            task.cancel();
            (0,_addingProjectDOM__WEBPACK_IMPORTED_MODULE_7__.clearCatDom)();
            (0,_addingProjectDOM__WEBPACK_IMPORTED_MODULE_7__.clearProjectDom)();
            (0,_addingProjectDOM__WEBPACK_IMPORTED_MODULE_7__.projectDom)();
            (0,_addingProjectDOM__WEBPACK_IMPORTED_MODULE_7__.addProjectToStorage)();
            break;
        case 'delete-local':
            deleteStorage();
            break;
    ...
    switch (data) {
        case 'organize':
            (0,_icons__WEBPACK_IMPORTED_MODULE_1__.focusEffects)(id, index);
            break;
        case 'non-completed':
        ...
        case 'edit':
            ...
            break;
        case 'project-trash':
            (0,_addingProjectDOM__WEBPACK_IMPORTED_MODULE_7__.deleteProjectDom)(index, id);
            break;
    }
})
