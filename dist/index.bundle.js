...
function getData(index) {
    ...
    if (num > 0) {
        const projectCheck = document.getElementById(`cat-project-${_addingProjectDOM__WEBPACK_IMPORTED_MODULE_0__.projects[index]}`);
        if (projectCheck.style.display === 'block') {
            arr.push(taskCreator(title, description, date, _addingProjectDOM__WEBPACK_IMPORTED_MODULE_0__.projects[index]));
        } else {
